...
public enum SpectrumType { RawSample, Realtime, PeakLevel, MeanLevel };
...
public class AudioSpectrum : MonoBehaviour
{
	...
	public SpectrumType spectrumType = SpectrumType.Realtime;
	...
	public int Length {
		get {
			...
			case SpectrumType.PeakLevel:
				return PeakLevels.Length;
				break;
			case SpectrumType.MeanLevel:
				return MeanLevels.Length;
				break;
			case SpectrumType.RawSample:
				return rawSpectrum.Length;
				break;
			default:
				return Levels.Length;
			}
